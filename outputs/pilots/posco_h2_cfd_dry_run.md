...
- Enterprise transition-window charge: 21.27 bps (`enterprise_transition_window.reform_priced.full_counterfactual.ev_normalized`)
- Project-from-base-year charge: 22.30 bps (`project_from_base_year.reform_priced.fixed_commissioning.ev_normalized`)
