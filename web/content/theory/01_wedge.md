...
**현행 수치**: `outputs/wedge.json`·`condition_gap.json` (POSCO 누적 gap 252 MtCO₂, 최초 이탈 2032). τ*는 예산 없는 measure — A2와 R5 참조. 사적 전환 확률이 문턱 미만인 자산(τ*=None)은 '지평 내 사적 전환 없음'으로 처리된다.
