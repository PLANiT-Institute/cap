...
이 공리의 경험적 발톱이 Figure 4다: POSCO의 탄소는 비용 share 38.5% vs 위험 share 52.2% — 평균으로 나누면 anatomy를 잘못 말한다. (`outputs/cost_vs_risk.json`)
...
**현행 stranding**: A03, A08 (`outputs/stranding.json`).
