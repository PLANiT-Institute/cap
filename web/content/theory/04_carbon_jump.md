...
시나리오 {SQ $12 · 0.45} · {MSR $35 · 0.35} · {CBAM $85 · 0.20}로 σ_carbon은 0.40("개혁 미가격") → **0.88**("개혁 가격")로 상승하고, POSCO의 탄소 share는 49.3% → 82.2%로 뒤집힌다. 그 차이가 곧 자국 정책 불확실성이 만든 프리미엄의 몫이다 — 한국 철강 프리미엄의 탄소 share는 자국 정부의 정책 궤적에 대한 노출이라는 해석의 엔진.
