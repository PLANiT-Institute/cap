...
현재 산출 (base, 각국 현물 탄소가 — 기준일 14.93$/t는 2026-06-30 종가):

| 기업 | LEVEL $/t | σ_project | m | WEDGE $/t |
|---|---|---|---|---|
| POSCO | 347 | 0.228 | 1.79x | 273 |
| NIPPON | 380 | 0.249 | 2.05x | 401 |
| JFE | 131 | 0.174 | 1.66x | 87 |
| KOBE | 109 | 0.167 | 1.63x | 69 |
...
- H₂ CfD 단독은 τ*를 **늦추고**(POSCO +1.11y) charge를 줄이지 못한다 —
